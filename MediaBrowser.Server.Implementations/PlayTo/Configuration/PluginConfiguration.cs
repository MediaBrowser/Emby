...
namespace MediaBrowser.Server.Implementations.PlayTo.Configuration
{
    ...
    {
        private static string[] _supportedStaticFormats = new string[] { "mp3", "flac", "m4a", "wma", "avi", "mp4", "mkv", "ts" };
        ...
        private static DlnaProfile[] _profiles = GetProfiles();
        ...
        private static DlnaProfile[] GetProfiles()
        {
            ...
            profile0.TranscodeSettings = TranscodeSettings.Default;
            ...
            profile1.TranscodeSettings = TranscodeSettings.Default;
            ...
            profile2.TranscodeSettings = TranscodeSettings.Default;
            ...
            profile3.TranscodeSettings = new TranscodeSettings[] { new TranscodeSettings { Container = "mkv", TargetContainer = "ts" }, 
            ...
            profile4.TranscodeSettings = new TranscodeSettings[] { new TranscodeSettings { Container = "mkv", TargetContainer = "ts" }, 
                                                                  new TranscodeSettings { Container = "flac", TargetContainer = "mp3" },
                                                                  new TranscodeSettings { Container = "m4a", TargetContainer = "mp3" }};
            ...
            profile5.TranscodeSettings = TranscodeSettings.Default;
            ...
            profile6.TranscodeSettings = new TranscodeSettings[] { };
